...
import {createDevice, fetchBrands, fetchTypes} from "../../htpp/deviceAPI";
...
const CreateDevice = observer(({show, onHide}) => {
    ...
    const addDevice = () => {
        ...
        createDevice(formData).then(() => onHide())}catch (e){
            alert(e)
        }
    }
    const selectFile = e => {
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    ...
                    />
                    <hr/>
                    <Button variant={"outline-dark"} onClick={addInfo}>Add new feature</Button>
                    {
                        info.map(i =>
